...
public class ALMCompilerSettings {
	...
	public static final String DEFAULT_SPARC_LOCATION = "sparc.jar"; //assumes sparc.jar is in current working directory
	...
	public void printUsage(){
		...
		System.out.print("  If java version 1.8.* is not installed on your path then the location of the proper java executable must be provided.");
		System.out.print("  SPARC requires an ASP Solver, either clingo or dlv and the directory and type of solver must be indicated.");
		System.out.print("  These settings can be specified on the commandline or be provided in a config file.");
		System.out.print("  Once the proper settings are determined, you can export them to a config file with '-cc configfile' at the end of the commandline.");
		System.out.print("  You can use a config file with '-c configfile'.\n");
		System.out.println("Usage:\n");
		System.out.println("Any entry without a commandline option is assumed to be the path to the input ALM System Description.\n");
		...
		System.out.print("  Provide the <path> to the directory containing the ASP Solver and indicate the <type> as one of (dlv | clingo).");
		...
		System.out.print("  Provide <filename> to write the intermediate ASPf representation of the axioms and structure.");
		...
		System.out.print("  If absent, the first unqualified commandline argument is assumed to be the proper input file.");
		System.out.print("  If absent, and there is no unqualified commandline argument, input is read from standard in on console.");
		System.out.println("  To override a config file and force reading from standard in, use '"+STD_IN+"' as the filename.\n");
		...
		System.out.println("  Debug Settings send errors to standard err and all content to standard out on the console.\n");
		...
		for(int i = 0; i < args.length; i++){
			...
			case CL_OPTIMIZATION: 
				...
				case OFF:
					break;
					default:
					printUsageAndExitWithError("Optimization setting must be either 'on' or 'off', and not '"+args[i]+"'");
				}
	...
	private void createConfigFile(String filename) {
		...
		try {
			...
			out.write("#Executable name of solver on file system will need to be changed to match either dlv or clingo.\n");
			...
			out.write("#Destination file for intermediate ASP{f} representation of axioms and structure. (Primarily for debugging purposes)\n");
			...
			out.write("#If commented out, default is not to output the program to the user, merely send it to SPARC.\n");
			out.write("#uncomment the following to send to standard out. \n");
